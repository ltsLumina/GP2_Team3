...
class VIScriptComponentEditor : Editor
{
        ...
        void drawBody()
        {
            ...
            void drawCurProperty()
            {
                ...
                void updateIndentLevel(string path)
                {
                    ...
                    if (prev > EditorGUI.indentLevel) Space(6);
                }
    ...
    public void SetupData()
    {
        ...
        if (datasByTarget.ContainsKey(target) && datasByTarget[target] != null) data = datasByTarget[target];
